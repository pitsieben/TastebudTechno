...
namespace extOSC.Examples
{
	public class MappingExample : MonoBehaviour
	{
		...
		private const string _rotateAddress = "/CelloVol";

		private const string _scaleAddress = "/CelloVol";

		private const string _positionAddress = "/CelloVol";
		...
		{
			var vector = new Vector3(value,1,1);
